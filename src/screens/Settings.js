...
export default function SettingsScreen() {
  ...
  const handleClearKey = async () => {
    Alert.alert("清除 API Key", "确定要删除已保存的 Gemini API key 吗？", [
  ...
  return (
    ...
    >
      ...
      {/* API Key */}
      <Section label="Gemini API Key" sub="AI 导师功能所需">
        ...
        <PaperInput
          ...
          placeholder={hasKey ? "粘贴新 key 以替换现有的…" : "AIza…"}
          secureTextEntry
          autoCapitalize="none"
          autoCorrect={false}
        ...
        <Pressable onPress={() => Linking.openURL("https://aistudio.google.com/apikey")}
          ...
          <TMono style={{ fontSize: 11 }}>前往 Google AI Studio 获取免费 key</TMono>
        </Pressable>
      </Section>
      ...
      <Section label="About · 关于" sub="隐私与成本">
        ...
        <View style={{ marginTop: 14, padding: 12, backgroundColor: colors.bgCard, borderWidth: 1, borderColor: colors.dividerSoft }}>
          ...
          <TSerif style={{ fontSize: 12, lineHeight: 20, color: colors.inkSoft }}>
            ...
            • Google Gemini 仅在你求教导师时收到相关档案片段{"\n"}
